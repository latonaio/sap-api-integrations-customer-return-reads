...
import (
	...
	sap_api_input_reader "sap-api-integrations-customer-return-reads/SAP_API_Input_Reader"
	"sap-api-integrations-customer-return-reads/config"
...
func main() {
	...
	caller.AsyncGetCustomerReturn(
		inputSDC.CustomerReturn.CustomerReturn,
		inputSDC.CustomerReturn.CustomerReturnItem.CustomerReturnItem,
		accepter,
	)
}
